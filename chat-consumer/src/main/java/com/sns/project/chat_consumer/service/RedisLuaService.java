...
public class RedisLuaService {
    ...
    public RedisLuaService(RedisTemplate<String, String> redisTemplate) {
     ...
     */
    public com.sns.project.chat_consumer.service.dto.LastReadIdInfo processUnreadMessages(String lastReadKey, String messageZSetKey, String unreadCountHashKey) {
